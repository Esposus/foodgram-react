# Generated by Django 2.2.16 on 2022-12-07 15:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Уникальное имя пользователя', max_length=150, unique=True, validators=[django.core.validators.RegexValidator('^[\\w.@+-]+$', 'Использованы недопустимые символы!')], verbose_name='Юзернейм')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('author', models.ForeignKey(help_text='Автор, на которого можно подписаться', on_delete=django.db.models.deletion.CASCADE, related_name='followig', to=settings.AUTH_USER_MODEL, verbose_name='Автор')),
